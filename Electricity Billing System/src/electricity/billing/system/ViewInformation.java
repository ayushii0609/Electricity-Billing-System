...
public class ViewInformation extends JFrame implements ActionListener{
    ...
    ViewInformation(String meter){
        ...
        lblphn.setBounds(500,200,100,20);
        add(lblphn);
        ...
        // Add the background image below the cancel button  
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/viewcustomer.jpg"));
        Image i2 = i1.getImage().getScaledInstance(800, 250, Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2);
        JLabel image = new JLabel(i3);
        image.setBounds(0, 370, 800, 250); // Adjust position to be below cancel button
        add(image);
